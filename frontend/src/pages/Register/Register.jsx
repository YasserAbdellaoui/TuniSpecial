...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    else{navigate('/AboutUs')} //ken fama admin page houni you navigate him to
    }
    )
    .catch((error) => {
      ...
      <div className="w-1/2 bg-[#EBEFFF] flex justify-center items-center">
        <div>
          ...
          <form>
            ...
            <div className="flex flex-col">
              <label className="text-base font-normal" htmlFor="Age">
                Age
              </label>
              <input
                className="w-full bg-transparent rounded-[50px] border border-[#656ED3] p-2 mt-3"
          ...
          <h3 className="flex justify-center">
            ...
            <Link to={"/Login"} style={{ fontFamily: "arial", marginLeft: "10px" }}>
              Login
            </Link>
          </h3>
