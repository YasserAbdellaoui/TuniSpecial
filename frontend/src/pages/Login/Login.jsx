      ...
      <div className="w-2/3 bg-[#EBEFFF] flex justify-center items-center">
        <div className=" w-1/2 space-y-3">
          ...
          <h3>
            ...
            <Link to={"/register"} style={{ fontStyle: "bold" }}>
              Register{" "}
            </Link>
          </h3>
          <div
